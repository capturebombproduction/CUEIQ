...
with ev(eid, gid, ename, status, stage_s, stage_e, booth_s, booth_e, photo_s, photo_e) as (
  values
    ('00000000-0000-0000-0000-0000000ffe01'::uuid,'bf6ace31-eed8-4b84-bef3-7b75d45d101e'::uuid,'🧪 TEST FEST — V!NX',         'pending_review','10:00','10:30','10:40','11:10','11:20','11:35'),
    ('00000000-0000-0000-0000-0000000ffe02'::uuid,'9fa66a5c-5be6-4c15-a4a7-67a51f80f066'::uuid,'🧪 TEST FEST — KŌMA',         'draft',         '10:45','11:15','11:25','11:55','12:05','12:20'),
    ('00000000-0000-0000-0000-0000000ffe03'::uuid,'cfe82737-77ec-4c03-8cd8-858fbfb86a97'::uuid,'🧪 TEST FEST — TERASHI',      'in_progress',   '11:30','12:00','12:10','12:40','12:50','13:05'),
    ('00000000-0000-0000-0000-0000000ffe04'::uuid,'4a7ae06f-ac32-40ad-8d10-5bc7418dd323'::uuid,'🧪 TEST FEST — HatoBito',     'approved',      '12:15','12:45','12:55','13:25','13:35','13:50'),
    ('00000000-0000-0000-0000-0000000ffe05'::uuid,'cefc2fec-f36c-4af8-9dfd-5584aa8ba06f'::uuid,'🧪 TEST FEST — KNIGHT✠RES',   'pending_review','13:00','13:30','13:40','14:10','14:20','14:35'),
    ('00000000-0000-0000-0000-0000000ffe06'::uuid,'4bc8f4ca-f9a0-4db7-94dc-999077287e40'::uuid,'🧪 TEST FEST — ANGeVIL✟',     'draft',         '13:45','14:15','14:25','14:55','15:05','15:20'),
    ('00000000-0000-0000-0000-0000000ffe07'::uuid,'d533b546-edf5-427e-a31f-8f32399aeeac'::uuid,'🧪 TEST FEST — LUMIN+US',     'in_progress',   '14:30','15:00','15:10','15:40','15:50','16:05'),
    ('00000000-0000-0000-0000-0000000ffe08'::uuid,'c8788874-d6f9-41bd-a675-5d7628a15881'::uuid,'🧪 TEST FEST — Seishin Kakumei','approved',    '15:15','15:45','15:55','16:25','16:35','16:50')
)

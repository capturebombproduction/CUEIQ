...
- `audible` **วัดในตัว Chromium ก่อนถึงมิกเซอร์ของ Windows** — พูดได้แค่ว่า "แอปผลิตสัญญาณเสียงจริง"
  บอกไม่ได้ว่าลำโพงเสียบอยู่ เปิดอยู่ หรือดังออกมาในห้องจริง ๆ **ยังต้องมีคนฟังอยู่ดี** แต่คนละคำถามกับเมื่อก่อน:
  เดิมคือ "แอปทำงานไหม" ตอนนี้เหลือแค่ "ลำโพงต่อถูกไหม"
